...
const productData = {
  ...
  "performance-jogger": {
    ...
    isBestSeller: true,
    modelInfo: "Model is 5'11\" and wearing a size M.",
  },
  "daily-legging": {
    id: 3,
    name: "Daily Legging",
    ...
    image: dailyLegging,
    isBestSeller: false,
    modelInfo: "Model is 5'8\" and wearing a size S.",
  },
  "meta-pant": {
    id: 4,
    name: "Meta Pant",
    ...
    image: metaPant,
    isBestSeller: true,
    modelInfo: "Model is 5'9\" and wearing a size M.",
  },
};

const ProductDetailWithTryOn = () => {
...
export default ProductDetailWithTryOn;

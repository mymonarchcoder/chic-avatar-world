      ...
      <div className="fixed inset-0 z-50 bg-white flex items-center justify-center animate-fade-in">
        <div className="w-full h-full max-w-7xl flex flex-col overflow-hidden animate-scale-in relative">
          ...
          <div className="h-full flex overflow-hidden relative">
            ...
            <div className="flex flex-col justify-center items-start h-full flex-shrink-0 w-[55%] overflow-visible">
              <div 
                ref={avatarRef}
                className="relative flex items-center justify-start overflow-visible h-full w-full pl-8"
              >
                {/* Animated Avatar */}
                <AnimatedAvatar
